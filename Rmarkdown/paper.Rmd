...
(3) Autocorrelation, or memory effects. Autocorrelation means the current state of the system depends on its history. For example, the effect of a perturbation to corrosion scale is evident for some time after the fact. From a statistical perspective, autocorrelation makes parameter estimates more uncertain [@helsel_statistical] by reducing the effective sample size (i.e., the information content of the sample) [@gelman_bayesian_2014]. It is very likely to be a feature of any pipe loop study dataset where effluent from pipes is sampled repeatedly over time.
