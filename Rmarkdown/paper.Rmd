...
Time series of particulate and dissolved lead featured prominent negative trends after the introduction of orthophosphate, followed by an extended period of relative stability. The dissolved lead time series were seasonal, with maximum levels in late summer and minimum levels in early spring (Figure 4a). To estimate the time-varying mean representing each series, we modeled lead as the sum of a global multi-year smoother, a seasonal smoother (dissolved lead only), a group-level multi-year smoother, a local intercept for each pipe, and a continuous-time autocorrelated error term (Figure 6).
